// Spirit Airlines Banner Injection Script
(function() {
    'use strict';
    
    // Wait for the page to load
    function addSpiritBanner() {
        // Check if banner already exists
        if (document.getElementById('spirit-banner')) {
            return;
        }
        
        // Create the banner element
        const banner = document.createElement('div');
        banner.id = 'spirit-banner';
        ...
        // Create the Spirit logo container
        ...
        tagline.style.cssText = `
            ...
            font-style: italic;
        `;
        tagline.textContent = 'Business Intelligence Agent';
        
        // Add logo and tagline to container
        logoContainer.appendChild(logo);
        logoContainer.appendChild(tagline);
        
        // Create the right side with Spirit's tagline
        ...
        rightSide.style.cssText = `
            ...
            letter-spacing: 1px;
        `;
        rightSide.textContent = 'LESS MONEY. MORE GO.';
        ...
        // Simple approach: just add the banner, let CSS handle the rest
        
        console.log('🛫 Spirit Airlines banner added successfully!');
    }
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', addSpiritBanner);
    }
    
    // Try again after a short delay to catch any dynamic content
    setTimeout(addSpiritBanner, 1000);
    setTimeout(addSpiritBanner, 3000);
    ...
    new MutationObserver(() => {
        ...
        if (url !== lastUrl) {
            lastUrl = url;
            setTimeout(addSpiritBanner, 500);
        }
